...
public class XorGate extends Element {
    ...
    public void draw(Camera c, Selection s, Simulator sim) {
        ...
        // body
        r.drawElementLine(new Vector2D(-0.6f, 0.6f), new Vector2D(-0.45f, 0.4f), selected);
        r.drawElementLine(new Vector2D(-0.45f, 0.4f), new Vector2D(-0.3f, 0), selected);
        r.drawElementLine(new Vector2D(-0.4f, 0.6f), new Vector2D(-0.25f, 0.4f), selected);
        r.drawElementLine(new Vector2D(-0.25f, 0.4f), new Vector2D(-0.1f, 0), selected);
        r.drawElementLine(new Vector2D(-0.4f, 0.6f), new Vector2D(0.4f, 0.6f), selected);
